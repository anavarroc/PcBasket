...
class TwoThreeZoneDefenceStrategyTest extends TestCase
{
    private RoleFactory $roleFactory;
    private TwoThreeZoneDefenceTacticCalculator $strategy;

    protected function setUp(): void
    {
        parent::setUp();
        $this->roleFactory = new RoleFactory();
        $this->strategy = new TwoThreeZoneDefenceTacticCalculator(
    ...
    /**
     * @dataProvider notEnoughSmallForwardsData
     */
    public function testShouldThrowsNotEnoughSmallForwards($data)
    {
        try {
            $this->strategy->execute($this->collectionFromData($data['players']));
        } catch (NotEnoughPlayersForGivenRoleException $e) {
    ...
    public function notEnoughSmallForwardsData()
    {
        return new JsonDataProviderIterator(__FILE__, 'notEnoughSmallForwardsData');
    }
